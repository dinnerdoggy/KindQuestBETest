...
To update the database use this command from the Web project folder (replace `KindQuestBE` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../KindQuestBE.Infrastructure/KindQuestBE.Infrastructure.csproj -s KindQuestBE.Web.csproj
```
